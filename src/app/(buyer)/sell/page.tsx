  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-10">
      ...
      <FadeIn className="relative bg-[#EFEAE1] rounded-[2.5rem] sm:rounded-[3.25rem] p-6 sm:p-10 lg:p-12 overflow-hidden shadow-card text-center space-y-4">
        ...
        <div className="absolute top-0 right-0 w-72 h-72 bg-[#5E6F3D]/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#7A8C53]/15 rounded-full blur-2xl pointer-events-none" />
      ...
      {/* 2. Interactive Selling Model Pill Selector */}
