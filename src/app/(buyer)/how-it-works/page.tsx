...
export default function HowItWorksPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-12 sm:space-y-16">
      {/* 1. Fluid Editorial Hero */}
      <FadeIn className="relative bg-[#EFEAE1] rounded-[2.5rem] sm:rounded-[3.25rem] p-6 sm:p-10 lg:p-14 overflow-hidden shadow-card text-center space-y-4">
      ...
      {/* 2. Side-by-Side Comparison: Old Marketplace vs MiThrift */}
