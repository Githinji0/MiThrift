...
import { MapPin, ShieldCheck, MessageCircle, Heart, ArrowRight } from 'lucide-react';

export const Footer: React.FC = () => {
  return (
    <footer className="bg-charcoal text-canvas pt-16 pb-24 md:pb-16 border-t border-charcoal-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-muted-clay/30">
          {/* Brand & Mission */}
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-olive flex items-center justify-center text-canvas font-black text-lg">
                M
              </div>
            ...
            <div className="inline-flex items-center gap-2 text-xs text-emerald-400 bg-emerald-950/60 px-3 py-1.5 rounded-lg border border-emerald-800/40">
            ...
            <ul className="space-y-2.5 text-xs text-muted-clay">
              ...
              <li>
                <Link href="/drops" className="hover:text-canvas transition-colors flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] bg-amber-500 text-charcoal px-1.5 py-0.2 rounded font-black">HOT</span>
                </Link>
              </li>
              <li>
          ...
          <div className="bg-sandstone/10 p-5 rounded-2xl border border-muted-clay/20 flex flex-col justify-between">
            <div>
            ...
            <Link
              href="/sell"
              className="mt-4 inline-flex items-center justify-between px-4 py-2.5 rounded-xl bg-olive hover:bg-olive-hover text-canvas font-bold text-xs transition-all"
            >
